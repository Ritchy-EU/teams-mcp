export function registerAuthTools(server, graphService) {
    ...
    server.tool("start_authentication", "Start Microsoft Teams authentication via device code flow. Returns a URL and code for the user to complete sign-in in their browser. Use this when auth_status shows not authenticated.", {}, async () => {
        try {
